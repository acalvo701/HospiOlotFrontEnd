...
export class GuardiaApiService {
  ...
  getGuardiesByDay(data: string):Observable<any>{
    const requestOptions = this.createHeader();
    return this.http.get('http://localhost:4000/guardia/getGuardiesByDay?data='+data, requestOptions);
  }

  reservarGuardia(idGuardia:string,idTreballador:string = "8"):Observable<any>{
    const requestOptions = this.createHeader();
    return this.http.post('http://localhost:4000/guardiatreballador/bookGuardia?idGuardia='+idGuardia+'&idTreballador='+idTreballador, requestOptions);
  }

  getGuardiesByDayFromTreballador(dia:string,idTreballador:string = "8"):Observable<any>{
    const requestOptions = this.createHeader();
    return this.http.get('http://localhost:4000/guardiatreballador/getGuardiesByDayFromTreballador?dia='+dia+'&idTreballador='+idTreballador, requestOptions);
  }

  cancelarGuardia(idGuardia:string,idTreballador:string = "8"):Observable<any>{
    const requestOptions = this.createHeader();
    return this.http.post('http://localhost:4000/guardiatreballador/cancelGuardia?idGuardia='+idGuardia+'&idTreballador='+idTreballador, requestOptions);
  }
